  ...
  <div id="home" class="tab-pane fade in active">
        ...
        <div class="box" style="margin-bottom: 0;">        
            <p>
                ...
                <span class="value">Q186330254@ybl</span>
                <button class="btn copyBtn" data-clipboard-text="Q186330254@ybl">Copy</button>
            </p>
  ...
  <div id="menu1" class="tab-pane fade">    
        ...
        <div class="box" style="margin-bottom: 0;">
            ...
            <p>
                ...
                <button  class="btn copyBtn" data-clipboard-text="">Copy</button>
            </p>
            <p>
...
<form class="paymentRefForm" action="" method="POST" autocomplete="off">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="email" placeholder="Enter Registerd Phone Number" required>
    </div>
