...
$sql= "UPDATE `content` SET `riskagreement` = '$content' WHERE `id`= '1'";
$query=mysqli_query($con,$sql);
if($query){
	
	header("location:riskagreement.php?msg=updt");
...
<head>
  ...
  <title>Adminsuit | Risk Disclosure Agreement</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Risk Disclosure Agreement</li>
      </ol>
    </section>
...
<label for="content">Risk Disclosure Agreement</label>
<textarea id="content" class="ckeditor" name="content"><?php echo @$role["riskagreement"]; ?></textarea>
</div></div>
